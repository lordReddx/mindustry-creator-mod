    ...
    requirementInfos: [
        ...
        },
        {
            ...
            requirements: defineItemRequirements([
                ...
                { item: AX.guijingti, amount: 2000 },
                { item: AX.xi, amount: 1200 }, 
                { item: AX.molishi, amount: 50 },
            ])
        },
        {
            launchCount: 3,
            requirements: defineItemRequirements([
                { item: Items.copper, amount: 7000 },
                { item: Items.lead, amount: 7000 },
                { item: AX.guijingti, amount: 3000 },
                { item: AX.xi, amount: 1500 }, 
                { item: AX.molishi, amount: 100 },
                { item: AX.weijing2, amount: 50 },
            ])
        },
         {
             launchCount: 4,
             requirements: defineItemRequirements([
                 { item: Items.copper, amount: 10000 },
                 { item: Items.lead, amount: 10000 },
                 { item: AX.xi, amount: 5000 },
                 { item: AX.molishi, amount: 3000 },
                 { item: AX.weijing2, amount: 200 },
                 { item: AX.monengjing1, amount: 500 },
                 { item: AX.weijing3, amount: 100 },
         ...
         },
         {
             ...
             requirements: defineItemRequirements([
                 { item: AX.invalid, amount: 999999999 },
             ])
         },
         {
             launchCount: 6,
             requirements: defineItemRequirements([
                 { item: AX.invalid, amount: 1 },
             ])
         },
         {
             launchCount: 7,
